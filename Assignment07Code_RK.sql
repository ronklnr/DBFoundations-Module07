...
-- 2022-02-28, Ron Klangnarong, Created File
--**************************************************************************--

Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_RonKlangnarong')
	 Begin 
	  Alter Database [Assignment07DB_RonKlangnarong] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_RonKlangnarong;
	 End
	Create Database Assignment07DB_RonKlangnarong;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_RonKlangnarong;
